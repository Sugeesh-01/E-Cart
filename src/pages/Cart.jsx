        ...
        <div    className='col-span-2 border rounded p-5 shadow'>
            <table className='table-auto w-full'>
                ...
                <tbody>
                    <td>1</td>
                    <td>Product name</td>
                    <td><img width={'70px'} height={'70px'} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeDem-xiP3dM4D0u_BlotaGx1FKFf7FuncXw&s" alt="" /></td>
                    <div className='flex'>
                        <td> <button className='font-bold'>-</button>
